...
const SideNavbar = () => {
  return (
    ...
    <div style={{  width:'236px' , marginBottom: '12px',marginTop: "12px" ,marginRight:'10px' ,  alignSelf: 'flex-end'}}>
    <ProfileButton>
      <div>
        <img src={profileImg} alt=""  width='40px' height='40px' style={{borderRadius: '50%' , objectFit:'cover'}} />
      </div>

      <div style={{alignSelf: 'center', marginLeft: '10px', marginRight: '10px'}}>
